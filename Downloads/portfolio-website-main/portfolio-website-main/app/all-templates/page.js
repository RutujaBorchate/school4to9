...
{
    id: 4,
    title: 'Dr. Rishi Kulshresth Portfolio',
    description: 'Professional portfolio website for Dr. Rishi Kulshresth showcasing legal expertise, publications, and professional achievements.',
    icon: Users,
    image: '/images/templates/p4.png', // add screenshot in public/images/templates
    liveUrl: 'https://dr-rishi-kulshresth-website.vercel.app/',
    features: ['Professional Profile', 'Legal Expertise', 'Publications', 'Contact Section'],
    rating: 5,
    category: 'personal',
    detailedFeatures: [
...
},
{
    ...
    description: 'A sleek and modern developer portfolio showcasing projects, skills, and experience with a clean UI and smooth animations.',
    icon: Code,
    image: '/images/templates/d4.png', // Add screenshot image in public folder
    liveUrl: 'https://portpolio-three-jade.vercel.app/',
    features: ['Project Showcase', 'Skills Section', 'Responsive Design', 'Contact Integration'],
    rating: 5,
    category: 'developer',
    detailedFeatures: [
    ...
    },
   {
    ...
    description: 'Modern interactive developer portfolio with smooth scroll navigation showcasing projects, skills, and work highlights.',
    icon: Code,
    image: '/images/templates/d5.png', // add screenshot in public folder
    liveUrl: 'https://my-portfolio-kappa-eight-52.vercel.app/#projects',
    features: ['Project Highlights', 'Smooth Scrolling', 'Skills Section', 'Responsive Design'],
    rating: 5,
    category: 'developer',
    detailedFeatures: [
        'Hero intro with animated text',
        'Project showcase with descriptions & live links',
...
},
{
    ...
    description: 'Advanced portfolio designed for AI/ML engineers to showcase research projects, models, datasets, and technical publications.',
    icon: Code,
    image: '/images/templates/d6.png',
    liveUrl: 'https://portfolio-roan-two-86.vercel.app/', // replace if needed
    features: ['Research Projects', 'Model Showcase', 'Dataset Display', 'Publication Section'],
    rating: 5,
    category: 'developer',
    detailedFeatures: [
